...
public class Waybill implements java.io.Serializable {
	...
	/** full constructor */
	public Waybill(Branch branch, Emp emp, Payment payment, Servetype servetype, Order order, Waybilltype waybilltype,
			Pickingway pickingway, Date waybillTime, String deliveryRelease, Integer receiptNum, String wayBillRemarks,
			Double volumeUnitPrice, Double weightUnitPrice, Double loans, Double totalFreight, String deTuned,
			String duetothe, Set deliverywaybills) {
		this.branch = branch;
		this.emp = emp;
