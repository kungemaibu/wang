...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    <thead>
      <tr class="text-c">
        ...
        <th width="150">入库状态</th>
        <th width="130">库存体积</th>
        <th width="70">发站</th>
        <td width="70">目的站</td>
        <td width="70">路由</td>    
        <td width="70">发货人</td>
    ...
    <c:forEach items="${p.list }" var="re">
    		<tr>
    			...
    			<td>${re.remarks }</td>
                <td class="td-manage">
                <a href="Repertory_updateRepertory.action?repertory.repertoryId=${re.repertoryId }">出库</a>     
                <a title="修改" href="updateO.action?ocId=${o.ocId}" ><i class="Hui-iconfont">&#xe6df;</i></a> 
                <a title="删除" href="del.action?ocId=${o.ocId}" ><i class="Hui-iconfont">&#xe63f;</i></a> </td>
